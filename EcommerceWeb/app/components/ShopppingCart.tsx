...
const ShopppingCartModel = () => {
  ...
  async function handleCheckoutNow(event : any){
        ...
        <div className="h-full flex flex-col justify-between">
          <div className="mt-8 flex-1 overflow-y-auto">
            <ul className="-my-6 divide-y divide-gray-200 ">
              {cartCount === 0 ? (
                <h1 className="py-6">You Don't have any item</h1>
              ) : (
                <>
          ...
          <div className="border-t border-gray-200 px-4 py-6 sm:px-6">
            ...
            <p className="mt-0.5 text-sm text-gray-500">Shipping and texes are calculated at checkout</p>
              <div className="mt-6">
...
export default ShopppingCartModel;
